...
<base href="../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comasides/aside-5.html" />
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-footer="true" class="app-default">
													...
													<div class="col-lg-7">
														...
														<div class="row">
															...
															<div class="col-lg-4 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="asides/aside-5.html" class="menu-link active">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
																		</span>
																		<span class="menu-title">Calendar</span>
        ...
        -->
									...
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link active" href="asides/aside-5.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Calendar</span>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Calendar</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Asides</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6678170e4986c">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6678170e4986c" data-allow-clear="true">
																<option></option>
					...
					<div id="kt_app_aside" class="app-aside flex-column mt-7" data-kt-drawer="true" data-kt-drawer-name="app-aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_aside_toggle">
						<!--begin::Aside wrapper-->
						<div id="kt_app_aside_wrapper" class="hover-scroll-y px-5 mx-5 my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_header" data-kt-scroll-wrappers="#kt_app_aside" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
							<!--begin::Aside 5-->
							<div class="card card-reset card-p-0">
								<!--begin::Header-->
								<div class="card-header align-items-center min-h-auto mb-5">
									<h3 class="card-title text-gray-900 fs-3 fw-bold mb-0">Calendar</h3>
									<!--end::Title-->
									<!--begin::Toolbar-->
									<div class="card-toolbar mb-0">
										<!--begin::Menu- wrapper-->
										<div class="btn btn-icon bg-light w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											...
											<div class="timeline">
												...
												<div class="timeline-item">
													...
													<div class="timeline-content d-flex flex-row align-items-center sm-0">
														...
														<!--end::Time-->
														<!--begin::Bullet-->
														<span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center h-45px me-6 bg-warning"></span>
														<!--end::Bullet-->
														<!--begin:Author-->
											...
											<div class="timeline">
												...
												<div class="timeline-item">
													...
													<div class="timeline-content d-flex flex-row align-items-center sm-0">
														...
														<!--end::Time-->
														<!--begin::Bullet-->
														<span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center h-45px me-6 bg-info"></span>
														<!--end::Bullet-->
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<span class="text-gray-500 text-hover-primary fs-7 fw-bold">UI/UX Design</span>
											...
											<div class="timeline">
												...
												<div class="timeline-item">
													...
													<div class="timeline-content d-flex flex-row align-items-center sm-0">
														...
														<!--end::Time-->
														<!--begin::Bullet-->
														<span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center h-45px me-6 bg-primary"></span>
														<!--end::Bullet-->
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
											...
											<div class="timeline">
												...
												<div class="timeline-item">
													...
													<div class="timeline-content d-flex flex-row align-items-center sm-0">
														...
														<!--end::Time-->
														<!--begin::Bullet-->
														<span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center h-45px me-6 bg-success"></span>
														<!--end::Bullet-->
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
											...
											<div class="timeline">
												...
												<div class="timeline-item">
													...
													<div class="timeline-content d-flex flex-row align-items-center sm-0">
														...
														<!--end::Time-->
														<!--begin::Bullet-->
														<span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center h-45px me-6 bg-danger"></span>
														<!--end::Bullet-->
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<span class="text-gray-500 text-hover-primary fs-7 fw-bold">Marketing</span>
											...
											<div class="timeline">
												...
												<div class="timeline-item">
													...
													<div class="timeline-content d-flex flex-row align-items-center sm-0">
														...
														<!--end::Time-->
														<!--begin::Bullet-->
														<span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center h-45px me-6 bg-gray-700"></span>
														<!--end::Bullet-->
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<span class="text-gray-500 text-hover-primary fs-7 fw-bold">UI/UX Design</span>
															<span class="text-gray-800 fw-bold d-block fs-6">Market Dashboard Design</span>
														</div>
														<!--end:Author-->
													</div>
													<!--end::Timeline content-->
