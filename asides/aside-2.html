...
<base href="../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comasides/aside-2.html" />
													...
													<div class="col-lg-7">
														...
														<div class="row">
															...
															<div class="col-lg-4 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="asides/aside-2.html" class="menu-link active">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
																		</span>
									...
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link active" href="asides/aside-2.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Segments</span>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Segments</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6678171129bb2">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6678171129bb2" data-allow-clear="true">
																<option></option>
						...
						<div id="kt_app_aside_wrapper" class="hover-scroll-y px-5 mx-5 my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_header" data-kt-scroll-wrappers="#kt_app_aside" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
							...
							<div class="card card-reset card-p-0">
								...
								<div class="card-header min-h-auto mb-5">
									<h3 class="card-title text-gray-900 fs-3 fw-bold mb-5">Segments</h3>
									<!--begin::Search-->
									<form class="w-100 position-relative" autocomplete="off">
										...
										<!--begin::Input-->
										<input type="text" class="search-input form-control ps-13" name="search" value="" placeholder="Search..." />
										<!--end::Input-->
									</form>
									<!--end::Search-->
								</div>
								...
								<div class="card-body">
									...
									<ul class="nav nav-pills nav-pills-custom position-relative mb-4 gap-5">
										...
										<li class="nav-item">
											<!--begin::Link-->
											<a class="nav-link btn bnt-color-gray-600 btn-active-color-primary d-flex active justify-content-center w-100 border-0 h-100 px-0" data-bs-toggle="pill" href="#kt_aside_tab_1">
												<!--begin::Subtitle-->
										...
										<li class="nav-item">
											<!--begin::Link-->
											<a class="nav-link btn btn-color-600 btn-active-color-primary d-flex justify-content-center px-0 w-100 border-0 h-100" data-bs-toggle="pill" href="#kt_aside_tab_2">
												<!--begin::Subtitle-->
										...
										<div class="tab-pane fade show active" id="kt_aside_tab_1">
											...
											<div class="d-flex align-items-center py-3">
												...
												<div class="d-flex align-items-center">
													...
													<div class="me-5">
														<!--begin::Title-->
														<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Most Active</a>
														<!--end::Title-->
													</div>
													<!--end::Content-->
												</div>
											...
											<div class="d-flex align-items-center py-3">
												...
												<div class="d-flex align-items-center">
													...
													<div class="me-5">
														<!--begin::Title-->
														<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Top Errors</a>
														<!--end::Title-->
													</div>
													<!--end::Content-->
												</div>
											...
											<div class="d-flex align-items-center py-3">
												...
												<div class="d-flex align-items-center">
													...
													<div class="me-5">
														<!--begin::Title-->
														<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Signup rate</a>
														<!--end::Title-->
													</div>
													<!--end::Content-->
												</div>
											...
											<div class="d-flex align-items-center py-3">
												...
												<div class="d-flex align-items-center">
													...
													<div class="me-5">
														<!--begin::Title-->
														<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Signup errors</a>
														<!--end::Title-->
													</div>
													<!--end::Content-->
												</div>
											...
											<div class="d-flex align-items-center py-3">
												...
												<div class="d-flex align-items-center">
													...
													<div class="me-5">
														<!--begin::Title-->
														<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Support superstar</a>
														<!--end::Title-->
													</div>
													<!--end::Content-->
												</div>
