...
<base href="../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comtoolbars/accounting.html" />
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
							...
							<div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}" class="page-title d-flex flex-column justify-content-center flex-wrap me-3 mb-5 mb-lg-0">
								<!--begin::Title-->
								<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Accounting</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
									...
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link active" href="toolbars/accounting.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
										...
										<div class="d-flex align-items-center flex-shrink-0">
											...
											<div class="d-flex flex-shrink-0">
												...
												<div data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Invite friends">
													<a href="#" class="btn btn-sm btn-icon btn-active-color-success" data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">
									...
									<div class="d-flex align-items-center">
										...
										<div class="m-0">
											<!--begin::Select-->
											<select class="form-select form-select-sm form-select-solid w-md-125px" data-control="select2" data-placeholder="Filters" data-hide-search="true">
												<option value=""></option>
