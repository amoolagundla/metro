...
<base href="../../../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comapps/invoices/view/invoice-3.html" />
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6678170135dfb">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6678170135dfb" data-allow-clear="true">
																<option></option>
											...
											<div class="mw-lg-950px mx-auto w-100">
												...
												<div class="pb-12">
													...
													<div class="d-flex flex-column gap-7 gap-md-10">
														<!--begin::Message-->
														<div class="fw-bold fs-2">Dear Max Smith 
														<span class="fs-6">(max@kt.com)</span>,
														<br />
														...
														<div class="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
															...
															<div class="flex-root d-flex flex-column">
																...
																<span class="fs-5">23 June, 2024</span>
															</div>
															<div class="flex-root d-flex flex-column">
