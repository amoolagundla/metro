								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_66781714691f2">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_66781714691f2" data-allow-clear="true">
																<option></option>
												...
												<div class="card-body">
													...
													<div id="kt_user_view_details" class="collapse show">
														<div class="pb-5 fs-6">
															...
															<div class="text-gray-600">05 May 2024, 8:43 pm</div>
															<!--begin::Details item-->
														</div>
													</div>
													<!--end::Details content-->
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
																	<tbody>
																		<tr>
																			...
																			<td>POST /v1/customer/c_6678171469ee8/not_found</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_3215_4708/payment</td>
																			<td class="pe-0 text-end min-w-200px">24 Jun 2024, 10:30 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
																			</td>
																			<td>POST /v1/invoices/in_1813_3312/payment</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoice/in_9916_1678/invalid</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_8265_9046/payment</td>
																			<td class="pe-0 text-end min-w-200px">24 Jun 2024, 9:23 pm</td>
																		</tr>
																	</tbody>
																</table>
																<!--end::Table-->
															...
															<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
																<tbody>
																	...
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2024, 10:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		<a href="#" class="text-gray-600 text-hover-primary me-1">Emma Smith</a>has made payment to 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary">#XRS-45670</a></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2024, 10:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2024, 2:40 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#LOP-45640</a>has been 
																	...
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2024, 10:10 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#WER-45670</a>is 
																		<span class="badge badge-light-info">In Progress</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2024, 10:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		<a href="#" class="text-gray-600 text-hover-primary me-1">Melody Macy</a>has made payment to 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary">#XRS-45670</a></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2024, 8:43 pm</td>
																	</tr>
																</tbody>
															</table>
															<!--end::Table-->
