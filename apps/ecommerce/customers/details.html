								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_667816ff94f1a">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_667816ff94f1a" data-allow-clear="true">
																<option></option>
														...
														<div class="card-body pt-0 pb-5">
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	<tr>
																		<td>
																			<a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15470</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14754</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15415</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14738</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15876</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15863</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14844</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14817</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14535</a>
																		</td>
																		<td>
																			<span class="badge badge-light-warning">Pending</span>
																		</td>
																			...
																			<div class="flex-equal me-5">
																				<table class="table table-flush fw-semibold gy-1">
																					...
																					<tr>
																						...
																						<td class="text-gray-800">**** 2722</td>
																					</tr>
																					<tr>
																		...
																		<div class="d-flex flex-wrap py-5">
																			...
																			<div class="flex-equal me-5">
																				<table class="table table-flush fw-semibold gy-1">
																					...
																					<tr>
																						<td class="text-muted min-w-125px w-125px">Number</td>
																						<td class="text-gray-800">**** 3285</td>
																					</tr>
																					<tr>
																						<td class="text-muted min-w-125px w-125px">Expires</td>
																		...
																		<div class="d-flex flex-wrap py-5">
																			...
																			<div class="flex-equal me-5">
																				<table class="table table-flush fw-semibold gy-1">
																					...
																					<tr>
																						<td class="text-muted min-w-125px w-125px">Number</td>
																						<td class="text-gray-800">**** 7903</td>
																					</tr>
																					<tr>
																						<td class="text-muted min-w-125px w-125px">Expires</td>
