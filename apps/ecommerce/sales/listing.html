								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6678170523d75">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6678170523d75" data-allow-clear="true">
																<option></option>
												...
												<tbody class="fw-semibold text-gray-600">
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13763</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-06-15">
															<span class="fw-bold">15/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-22">
															<span class="fw-bold">22/06/2024</span>
														</td>
														<td class="text-end">
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13764</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-06-17">
															<span class="fw-bold">17/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-21">
															<span class="fw-bold">21/06/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-end" data-order="2024-06-13">
															<span class="fw-bold">13/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-20">
															<span class="fw-bold">20/06/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13766</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$397.00</span>
														</td>
														<td class="text-end" data-order="2024-06-14">
															<span class="fw-bold">14/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-19">
															<span class="fw-bold">19/06/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13767</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-06-18">
															<span class="fw-bold">18/06/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-end" data-order="2024-06-10">
															<span class="fw-bold">10/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-17">
															<span class="fw-bold">17/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-end" data-order="2024-06-12">
															<span class="fw-bold">12/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-16">
															<span class="fw-bold">16/06/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$451.00</span>
														</td>
														<td class="text-end" data-order="2024-06-08">
															<span class="fw-bold">08/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-15">
															<span class="fw-bold">15/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13771</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$274.00</span>
														</td>
														<td class="text-end" data-order="2024-06-13">
															<span class="fw-bold">13/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13772</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-06-07">
															<span class="fw-bold">07/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-13">
															<span class="fw-bold">13/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13773</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-06-09">
															<span class="fw-bold">09/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-12">
															<span class="fw-bold">12/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13774</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-06-06">
															<span class="fw-bold">06/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-11">
															<span class="fw-bold">11/06/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13775</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-06-04">
															<span class="fw-bold">04/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-10">
															<span class="fw-bold">10/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13776</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$171.00</span>
														</td>
														<td class="text-end" data-order="2024-06-05">
															<span class="fw-bold">05/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-09">
															<span class="fw-bold">09/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13777</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-06-02">
															<span class="fw-bold">02/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-08">
															<span class="fw-bold">08/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13778</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-06-01">
															<span class="fw-bold">01/06/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-07">
															<span class="fw-bold">07/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13779</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-end" data-order="2024-05-29">
															<span class="fw-bold">29/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-05">
															<span class="fw-bold">05/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13781</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13782</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-28">
															<span class="fw-bold">28/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-03">
															<span class="fw-bold">03/06/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13783</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-31">
															<span class="fw-bold">31/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-02">
															<span class="fw-bold">02/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13784</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-27">
															<span class="fw-bold">27/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-06-01">
															<span class="fw-bold">01/06/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13785</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$494.00</span>
														</td>
														<td class="text-end" data-order="2024-05-29">
															<span class="fw-bold">29/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13786</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-30">
															<span class="fw-bold">30/05/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13787</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-24">
															<span class="fw-bold">24/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-29">
															<span class="fw-bold">29/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13788</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-21">
															<span class="fw-bold">21/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-28">
															<span class="fw-bold">28/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13789</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13790</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-25">
															<span class="fw-bold">25/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-26">
															<span class="fw-bold">26/05/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13791</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-19">
															<span class="fw-bold">19/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-25">
															<span class="fw-bold">25/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13792</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-17">
															<span class="fw-bold">17/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-24">
															<span class="fw-bold">24/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13793</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-23">
															<span class="fw-bold">23/05/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13794</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-15">
															<span class="fw-bold">15/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-22">
															<span class="fw-bold">22/05/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13795</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end pe-0">
															<span class="fw-bold">$433.00</span>
														</td>
														<td class="text-end" data-order="2024-05-17">
															<span class="fw-bold">17/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13796</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-20">
															<span class="fw-bold">20/05/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13797</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-18">
															<span class="fw-bold">18/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-19">
															<span class="fw-bold">19/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13798</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-13">
															<span class="fw-bold">13/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-18">
															<span class="fw-bold">18/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13799</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-11">
															<span class="fw-bold">11/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-17">
															<span class="fw-bold">17/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13800</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-09">
															<span class="fw-bold">09/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-16">
															<span class="fw-bold">16/05/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13801</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13802</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-10">
															<span class="fw-bold">10/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-14">
															<span class="fw-bold">14/05/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13803</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-06">
															<span class="fw-bold">06/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-13">
															<span class="fw-bold">13/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13804</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-08">
															<span class="fw-bold">08/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-12">
															<span class="fw-bold">12/05/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13805</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-04">
															<span class="fw-bold">04/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-11">
															<span class="fw-bold">11/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13806</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13807</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13808</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-07">
															<span class="fw-bold">07/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-08">
															<span class="fw-bold">08/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13809</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-01">
															<span class="fw-bold">01/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-07">
															<span class="fw-bold">07/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13810</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-03">
															<span class="fw-bold">03/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-06">
															<span class="fw-bold">06/05/2024</span>
														</td>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13811</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-05-02">
															<span class="fw-bold">02/05/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-05">
															<span class="fw-bold">05/05/2024</span>
														</td>
														<td class="text-end">
															<a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions 
															<i class="ki-duotone ki-down fs-5 ms-1"></i></a>
													...
													<tr>
														...
														<td class="text-start" data-kt-ecommerce-order-filter="order_id">
															<a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13812</a>
														</td>
														<td>
															<div class="d-flex align-items-center">
																<!--begin:: Avatar -->
														...
														<td class="text-end" data-order="2024-04-30">
															<span class="fw-bold">30/04/2024</span>
														</td>
														<td class="text-end" data-order="2024-05-04">
															<span class="fw-bold">04/05/2024</span>
														</td>
