...
<base href="../../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comapps/subscriptions/add.html" />
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_667817005c46f">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_667817005c46f" data-allow-clear="true">
																<option></option>
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<td class="text-gray-800">**** 7972</td>
																				</tr>
																				<tr>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 7703</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 5634</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
