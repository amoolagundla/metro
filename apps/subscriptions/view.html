...
<base href="../../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comapps/subscriptions/view.html" />
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6678170d81fb8">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6678170d81fb8" data-allow-clear="true">
																<option></option>
														...
														<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
															<tbody>
																<tr>
																	...
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary">8860-6255</a></td>
																	<td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2024, 11:05 am</td>
																</tr>
																<tr>
																	<td class="min-w-400px">Invoice 
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">4980-7000</a>status has changed from 
																...
																<tr>
																	<td class="min-w-400px">Invoice 
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">6936-4753</a>status has changed from 
																...
																<tr>
																	...
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary">8721-2908</a></td>
																...
																<tr>
																	...
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary">1826-4225</a></td>
