...
<base href="../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comaccount/logs.html" />
															...
															<div class="col-lg-5 mb-6 mb-lg-0">
																...
																<div class="row">
																	...
																	<div class="col-lg-6">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="account/logs.html" class="menu-link active">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Logs & Notifcations</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_66781709eb143">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_66781709eb143" data-allow-clear="true">
																<option></option>
												...
												<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
													...
													<tbody>
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_7366_8674/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_8504_2496/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoice/in_2700_4564/invalid</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
															<td class="pe-0 text-end min-w-200px">21 Feb 2024, 10:30 am</td>
															<!--end::Timestamp=-->
														</tr>
														<!--end::Table row-->
														<!--begin::Table row-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoice/in_6653_4630/invalid</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_3602_4462/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
															<td class="pe-0 text-end min-w-200px">10 Nov 2024, 9:23 pm</td>
															<!--end::Timestamp=-->
														</tr>
														<!--end::Table row-->
														<!--begin::Table row-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_6955_4729/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/customer/c_66781709eb6dc/not_found</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/customer/c_66781709eb6dd/not_found</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
															<td class="pe-0 text-end min-w-200px">10 Mar 2024, 10:30 am</td>
															<!--end::Timestamp=-->
														</tr>
														<!--end::Table row-->
													</tbody>
